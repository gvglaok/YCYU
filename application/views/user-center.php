        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <div class="panel panel-info ckpanel">
                    ...
                    <div class="panel-footer text-right">
                        <button type="button" class="btn btn-primary">编辑资料</button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <div class="panel panel-info ckpanel">
                    ...
                    <div class="panel-footer text-right">
                        <button type="button" class="btn btn-primary" data-tggle="modal" data-target="tecModify"><i class="glyphicon glyphicon-pencil"></i> 编辑资料</button>
                    </div>
                </div>
            </div>
        </div>
